            ...
            var N, F, z, E, I, M, Q, X, W, G, V, H, Z, Y, _, K, $, J, ee, te, ne, re, ce, ae, ie, se, le, oe, de, be, je, ue, pe, xe, Oe, he, me, fe, ge, ve, ye, ke, we, Se, Ce, Te, Ae, De, Le, qe, Pe, Re, Ue, Be, Ne, Fe, ze, Ee, Ie, Me, Qe, Xe, We, Ge, Ve, He, Ze, Ye, _e = B,
                            ...
                            onClick: Object(bt.a)(dt.a.mark((function e() {
                                return dt.a.wrap((function(e) {
                                    for (;;) switch (e.prev = e.next) {
                                        ...
                                        case 4:
                                            i("".concat(o("Harvested"), "!"), o("Your %symbol% earnings have been sent to your wallet!", { symbol: "BSwap" })), e.next = 11;
                                            break;
                                        case 7:
                ...
                xn = function(e) {
                    var t = e.multiplier,
                        ...
                        r = Object(g.b)().t,
                        c = Object(R.jsxs)(R.Fragment, { children: [Object(R.jsx)(u.nc, { children: r("The Multiplier represents the proportion of BSwap rewards each farm receives, as a proportion of the BSwap produced each block.") }), Object(R.jsx)(u.nc, { my: "24px", children: r("For example, if a 1x farm received 1 BSwap per block, a 40x farm would receive 40 BSwap per block.") }), Object(R.jsx)(u.nc, { children: r("This amount is already included in all APR calculations for the farm.") })] }),
                ...
                kn = function(e) {
                    ...
                    return Object(R.jsxs)(gn, {
                        children: [Object(R.jsxs)(vn, { children: [Object(R.jsx)(u.nc, { bold: !0, textTransform: "uppercase", color: "secondary", fontSize: "12px", pr: "4px", children: "BSWAP" }), Object(R.jsx)(u.nc, { bold: !0, textTransform: "uppercase", color: "textSubtle", fontSize: "12px", children: S("Earned") })] }), Object(R.jsxs)(yn, {
                                ...
                                onClick: Object(bt.a)(dt.a.mark((function e() {
                                    return dt.a.wrap((function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 4:
                                                i("".concat(S("Harvested"), "!"), S("Your %symbol% earnings have been sent to your wallet!", { symbol: "BSwap" })), e.next = 11;
                                                break;
                                            case 7:
                ...
                Nn = function(e) {
                    var t = e.details,
                        ...
                        j = l.token,
                        p = l.dual,
                        x = l.lpSymbol && l.lpSymbol.toUpperCase().replace("BSwap", ""),
                ...
                ur = function() {
                    ...
                    var xe = pe.map((function(e) {
                        var t = e.token,
                            ...
                            r = t.address,
                            c = n.address,
                            a = e.lpSymbol && e.lpSymbol.split(" ")[0].toUpperCase().replace("BSWAP", "");
